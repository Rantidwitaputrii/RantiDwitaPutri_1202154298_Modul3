...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        int gridColumnCount = getResources().getInteger(R.integer.grid_column_count); //untuk ukuran kolom saat landscape dan potrait
        ...
        initializeData(); //memanggil initializeData
    }
